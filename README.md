...
We provide a library for the GNSS3 Click on our [LibStock](https://libstock.mikroe.com/projects/view/1532/gnss-3-click) 
...
- ``` gnss3_cmdSingle ``` - Sends provided command to the module
- ``` gnss3_setHandler ``` - Handler assignation to the provied command
- ``` gnss3_modulePower ``` - Turn on module
...
[LibStock](https://libstock.mikroe.com/projects/view/1532/gnss-3-click) page.
